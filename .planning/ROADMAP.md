...
- [ ] 02-01-PLAN.md — Walking skeleton: import questions, config, run clock, MANUAL router, state.json bootstrap, Control Room Note created and opened, plus the manual wiring audit
- [ ] 02-02-PLAN.md — The complete Control Room Note body and the empty-body trap gate
...
| 2. Routing, Bootstrap & Control Room Onboarding | 0/4 | Planned | - |
